...
<html>
  <head>
    ...
    <title>GURU MTS NEGERI 7 SLEMAN</title>
  ...
  <body class="hold-transition skin-blue-light sidebar-mini">
    <div class="wrapper">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs"><nama_login><?php echo $_SESSION['nm_gru']; ?></nama_login></span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      <nama_login><?php echo $_SESSION['nm_gru']; ?></nama_login>
                      <small><level_login>guru</level_login></small>
                    </p>
                  </li>
                  <!-- Menu Footer-->
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <p><nama_login><?php echo $_SESSION['nm_gru']; ?></nama_login></p>
            </div>
          </div>
      ...
      <footer class="main-footer">
        ...
        <div class="text">
          <b class="text-left">Copyright © 2018</b>
            <h12 class="text-left">SMK NEGERI 1 LEIHITU</h12>
              <h12 class="text-left">All Right Reversed</h12>
        </div>
        </div>
      </footer>
